...
// api key => 698894818687426
const fetchAllSuperHero = async(searchText) => {
    let url = `https://www.superheroapi.com/api.php/698894818687426/search/${searchText}`;
    try{
...
const RandomSuperHero = (id) => {
    const superHeroToken = 698894818687426;
...
document.getElementById("random").onclick = () => {
    RandomSuperHero(Math.ceil(Math.random() * 731 ))
}